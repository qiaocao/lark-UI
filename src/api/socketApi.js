...
/**
 * websocket类
 * @param {*} wsProtocol wss or ws
 * @param {*} ip 地址
 * @param {*} port 端口号
 * @param {*} paramStr 加在ws url后面的请求参数，形如：id=12
 ...
 */
const SocketApi = function (wsProtocol, ip, port, paramStr, param, heartbeatTimeout, reconnInterval, binaryType) {
